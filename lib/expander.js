...
var Controllers = {
  ...
  // Many thanks to whomever wrote the MCP2317 code, I lifted most
  // of this for the Digital I/O of the SX1509 <3
  SX1509: {
    ADDRESSES: {
      value: [0x3E]
    },
    ...
    initialize: {
      value: function(opts) {
        ...
        this.io.i2cConfig(opts);
        this.io.i2cReadOnce(this.address, 0x13, 2, (bytes) => {
          if(bytes[0] !== 255 || bytes[1] !== 0){
            throw new Error('SX1509 Not Detected at address given');
          }
        });
    ...
    setClock: {
      //for now, just sets the internal 2mHz clock on
      value: function(){
        this.io.i2cWrite(this.address, 0x1E, 0x40);
        this.io.i2cReadOnce(this.address, 0x1F, 1, function(data){
          data = data[0];
          let tmp = (data & ~(0b111 << 4)) | (0b001 << 4);
          this.io.i2cWrite(this.address, 0x1F, [tmp]);
        }.bind(this));
      }
    },
    digitalWrite: {
      value: function(pin, value) {
        ...
        this.io.i2cReadOnce(this.address, gpioaddr, 1, (data) => {
          gpio = data;
          if (value === this.io.HIGH) {
            gpio |= 1 << pin;
          } else {
    ...
    digitalRead: {
      value: function(pin, callback) {
        ...
        this.io.i2cRead(this.address, gpioaddr, 1, function(data) {
          var pinstate = ((0x00 | 1 << pin) & data[0]) == (0x00 | 1 << pin) ? 1 : 0;
          this.pins[pinIndex].value = pinstate;
          this.emit("digital-read-" + pin);
        }.bind(this));
      }
    },
  },
